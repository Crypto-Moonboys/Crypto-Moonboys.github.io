...
Crypto Moonboys is a public-facing living Web3 wiki and interactive game system built around the Graffiti Kings / GKniftyHEADS cultural universe. The system combines street-art-rooted culture, wiki-based lore, arcade games, XP progression, Telegram identity sync, factions, Battle Chamber proof layers, Block Topia access, NFTs, future game worlds, and creator/IP expansion.

The core insight is simple: most wikis are static. Crypto Moonboys is designed to react. A user can read lore, play an arcade game, earn XP, link identity, appear in activity systems, unlock deeper layers, and eventually build inside the universe.

The site should never be described as only an encyclopedia. It should never be described as only an arcade. It should never be described as only NFTs. Those are pieces. The whole thing is a living wiki system.

## The one-line pitch

**Crypto Moonboys is the living Web3 wiki where the GK universe becomes playable.**
...
Most wikis sit still. This one wakes up. Read the lore, then play the arcade. Earn XP, link Telegram, enter the Battle Chamber, and unlock deeper layers of the Crypto Moonboys universe. This is not a static archive. This is a world with memory, proof, movement, and a path for users to become builders.
...
**The pages explain the world. The arcade lets you enter it.**
...
Do not say Crypto Moonboys is only:

- a fan-driven crypto encyclopedia
- a static wiki
- just an arcade
- just an NFT project
- just a gamefi project
- just a Telegram group
- just a lore archive
...
# 3. Project History: Why This Exists

Crypto Moonboys starts from a real cultural foundation: Graffiti Kings / GKniftyHEADS. The project's own framing positions GK as a street-born culture engine with decades of work across graffiti, street art, workshops, outreach, music, radio, commercial campaigns, and community activation.

The important point for future agents: the Web3 system is not meant to replace the street history. It extends it.

## Before Web3

Before wallets, the street already had identity. Graffiti tags were public names. Crews were community layers. Walls were feeds. Murals were proof of work. Reputation was earned by showing up.

That logic maps naturally to Web3:

- tag -> identity
- wall -> page / zone
- crew -> faction
- reputation -> XP / status
- mural -> NFT / artefact / lore object
- public wall -> public wiki / public chain
- street signal -> Battle Chamber activity

## The Web3 pivot

When GK moved into Web3 through GKniftyHEADS, GraffPUNKS, NFTs, tokens, radio, and lore systems, the move was not just financial. It was cultural translation. The old wall became digital. The old public signal became global. The old crew logic became factions and communities.

## Why the wiki matters

A project with hundreds of characters, factions, categories, chains, lore pages, games, mechanics, tokens, storylines, and future world layers cannot survive as scattered Telegram messages or Substack posts alone. It needs memory. It needs structure. It needs a source of truth.

That is why the wiki is not optional.

The wiki is the memory engine.

But the wiki alone is not enough.

The system makes it alive.

---

# 4. Current Live Product Truth

Future agents must not guess what is live. The following is the current working truth to maintain until explicitly updated.
...
The user journey must be consistent across homepage, About pages, How to Play, Incubator, Community, Arcade, and future game pages.
...
3. Play the arcade.
4. Generate score.
5. Earn Arcade XP through accepted synced runs.
...
Score is generated by individual game runs. Score determines leaderboard rank only. Score does not equal XP.
...
# 7. Homepage Source of Truth

The homepage is not a generic launch page. It is the front door to the living wiki.
...
**Read the lore. Play the arcade. Earn XP. Link your identity. Enter the Battle Chamber. Unlock deeper layers.**

Subcopy:

**Crypto Moonboys is a living Web3 wiki. The pages explain the world. The arcade lets you enter it. The more you show up, the more the system opens.**
...
1. Explore the Wiki -> `/search.html`
2. Play Arcade -> `/games/`
3. Link Telegram -> `/gkniftyheads-incubator.html`

This order matters. The wiki is the foundation.

## Homepage section: Why this wiki is different

Required copy:

**Most wikis are static. This one reacts.**

Bullets:

- Pages explain the world
- Arcade turns reading into action
- XP tracks participation
...
# 8. Core Pages and Their Jobs

## `index.html` - Homepage

Job: Explain the living wiki in seconds and route users.
...
Job: Explain the project at a high level and point to the full system breakdown.

Must not become too long. It should link deeper.

## `about/what-is-crypto-moonboys.html` - Full system pitch

Job: Full WTF/WOW explainer for people who want the full picture.

Must include:

- History and GK roots
- System loop
...
Job: Explain how to actually use the system.
...
Job: Turn visitors into linked players.
...
- Run `/gklink`
- Click link
- Identity becomes sync-live

## `community.html` - Battle Chamber
...
# 9. Repository and Agent Architecture

The wider project should be understood as a split system. Future agents should not try to force every function into the public website repo.
...
It should not become an AI lab, crawler, or decision engine.

## SAM 1 / SAM WIK WIKI / field hunter layer

Role: crawling, discovery, extraction, publishing preparation, operational workflows.

This layer goes out into approved sources, gathers material, validates it, and prepares outputs.

Think of it as the roaming scout.

## SAM V2 / main brain layer

Role: intelligence, entity relationship logic, memory health, ranking, bible generation, canon control, gap detection, long-term structure.

Think of it as the strategic brain.

## Why the split matters

If everything lives in one repo, the project becomes unmanageable:
...
When sources disagree, future agents must follow this hierarchy.
...
## Active arcade game directories
...
- The wiki is alive.
- Living Web3 wiki.
- Pages explain the world. Arcade lets you enter it.
- Read -> Play -> Earn XP -> Link -> Battle Chamber -> Block Topia -> Build.
- XP is not given. It is earned through activity.
- Score = how well you play.
...
- fan-driven crypto encyclopedia
- static encyclopedia
- passive income
- claim rewards
- earn by logging in
...
# 13. Live Arcade System

The arcade is the first action layer of the living wiki.

## Role

The arcade turns passive reading into action. It gives users an immediate way to enter the world without needing to buy anything or understand everything first.

## Active game purpose

| Game | Role |
|---|---|
| Invaders 3008 | current season anchor game / reaction-survival theme |
| Asteroid Fork | shooter/survival game |
| Breakout Bullrun | breakout/physics skill game |
| Crystal Quest | puzzle / collection style game |
...
The Battle Chamber is the proof layer.

## Purpose

The Battle Chamber shows movement. It is the public activity signal for the living wiki.

It should display or route toward:
...
**The Battle Chamber is where activity shows. If you act, it shows. If you do nothing, nothing happens.**
...
# 15. Incubator / Telegram Sync

The Incubator is the identity bridge.

## Purpose

It turns a visitor into a persistent player identity.
...
2. Run `/gkstart`.
3. Run `/gklink`.
4. Click the signed link.
5. Return to the site.
6. Confirm sync-live state.

## Copy line

Use:

**Telegram makes identity persistent. Link once, then the system can remember your movement.**

## Commands

Current command language should include:

- `/gkstart` - start/register profile
- `/gklink` - create signed link / sync identity
- `/gkstatus` - status, XP, faction if wired
- `/gkleaderboard` - community XP if wired
- `/gkquests` - active quests if wired
- `/gkfaction` - faction view/join if wired
- `/daily` - daily XP only if confirmed live

Do not claim a command is live unless verified.
...
**City Block Topia is the playable layer where the Crypto Moonboys wiki becomes explorable territory.**
...
- Orthographic camera
- neon bloom / cyberpunk city feel
- procedural buildings
- zones and bridges
- NPC manager
- GraffPunk squad archetypes
...
| Zone | Function |
|---|---|
| Chainlight Reactor Dome | central authority power node |
| Queen Sarah P-fly's Tower | elite / story / political node |
| Hard Fork Arena | combat / event node |
| Honeycomb Residential Spires | civilian / social node |
| Zero-G Blade Cruiser Docks | transport / authority node |
| Vertical Farm Canopies | Nomad / sustainability node |
| Black Market Underbelly | contracts / trade / crime node |
| Graffiti Ruins | rebel safe-zone / lore wall |
| Null Prophet Shrine | corruption / anomaly node |
| Construction Cranes | expansion / build sites |

## Future zone requirements
...
- mission role
- visual corruption/tagging state
- future unlock table
...
Tagging is the core street-action mechanic. It converts a clicked surface or zone into visible rebellion progress.

Future implementation must make tagging meaningful:

- tags reveal lore
- tags increase zone influence
- tags cost or generate Rebel Ink depending on context
- tags can trigger NPC reaction
- tags can open wiki fragments
- tags can feed Battle Chamber events
...
Rebellion meter tracks district uprising pressure. It should connect to zone control, mission unlocks, and future faction progress.

## Zone control

Zones should have states:
...
Future agents should map these to lore pages and faction identity.
...
- Graffiti Kings / GKniftyHEADS
- Crypto Moonboys
- GraffPUNKS
- HODL Warriors
- Bitcoin Kid / Bitcoin Kid Army
- Crypto Moongirls
- Queen Sarah P-fly
- House of RackinSATS
- HODL Wars
...
- Forkborn / Hard Fork themes
- Null Prophet / corruption layers
- 3008 / future-world lore

## Important rule

Lore can be big, strange, dramatic, and mythic. Product copy must still separate live features from planned features.

A lore page can talk about future wars. A product page must say whether the feature is live.
...
## Current faction functions

- player alignment
- gameplay effects in arcade where wired
- Faction XP separate from Arcade XP
- future faction wars / seasonal competition potential

## Example faction directions

| Faction | Direction |
|---|---|
| GraffPUNKS | chaos, tags, street rebellion, combo energy |
| HODL Warriors | endurance, defense, holding ground |
| Diamond Hands | survival, conviction, long-run pressure |
| Bitcoin Kids | onboarding, signal, youth rebellion, Bitcoin Kid lore |
| Crypto Moongirls | elite signal, Queen Sarah layer, character/lore depth |
| Nomad Bears | movement, routes, hidden paths, logistics |
| AllCity Bulls | street territory, physical energy, large-scale markings |
| Forkborn | hard fork chaos, system breaks, mutation routes |
| Null Prophet layer | corruption, anomalies, system threat |
...
NFTs are not just collectibles. They are artefacts, identity objects, access points, and future ownership/IP anchors.

But do not overclaim.

## Use this language

- NFTs may support access, identity, art ownership, creator paths, and future utility.
- Ownership should lead to possibility, not guaranteed returns.
- The system is about action, not passive rewards.
...
- financial returns
- investment promise
- guaranteed token upside

## Open-source clarification

When GK says the project is "open source" in spirit, the intended meaning is not necessarily open-source software. The intended meaning is closer to:

**User-owned IP direction. Community-driven expansion. GK provides the floor; the community builds on top.**

Use:

**GK is the floor. The community builds on top.**
...
- canon relationships
- character/faction pages
- sourcing from approved documents
- consistency with existing world
- clear distinctions between lore and mechanics
...
- missing pages
- canonical hierarchy
- where deeper bible documents are needed
...
## Step 1: Read the source truth files
...
- Homepage says the wiki is alive.
- About page explains system.
...
|---|---|---|
| Wiki identity removed | Kills the actual foundation | Keep "living wiki" as primary identity |
...
Most people will get Crypto Moonboys wrong at first glance. They will see a wiki, arcade games, NFTs, crypto words, XP, Telegram sync, factions, Block Topia, HODL Wars, GraffPUNKS, GKniftyHEADS, and a wall of strange names. Then they will try to put it into a small box.

They will call it a game. Or a wiki. Or an NFT project. Or another Web3 community.

That is exactly how they miss it.
...
- wiki identity
- categories and article navigation
...
The most important line remains:
