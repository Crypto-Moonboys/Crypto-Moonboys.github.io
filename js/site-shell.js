...
(function () {
  ...
  function buildHeaderHtml(navHtml) {
    return `
        <div class="site-logo">
          <a class="site-logo-home" href="/index.html" aria-label="Crypto Moonboys home">
            ...
            <span>
              ...
              <span class="logo-sub">LIVE KNOWLEDGE NETWORK</span>
            </span>
          </a>
          <span class="logo-live-feed" aria-live="polite">
            <a class="logo-live-feed-link" href="/search.html">WIKI PAGES: <span class="logo-live-value" data-stat="article-count">-</span></a>
            <a class="logo-live-feed-link" href="/search.html">ARTICLES: <span class="logo-live-value" data-stat="total-articles">-</span></a>
          </span>
        </div>
