/**
 * meta-system.js — local meta-layer for Tetris Block Topia.
 *
 ...
 * Storage key: tetris_blocktopia_meta_v1  (unique per-game, never shared)
 */

const STORAGE_KEY = 'tetris_blocktopia_meta_v1';
...
export const MILESTONE_DEFS = [
  { id: 'wave5',       text: '🧱 Wave 5 Cleared!',           check: (r) => r.wave >= 5             },
  { id: 'firstBoss',   text: '💀 First Boss Wave Survived!',  check: (r) => r.bossesDefeated >= 1   },
  { id: 'chaos',       text: '🔥 Max Intensity Survived!',   check: (r) => r.highestIntensity >= 95 },
  { id: 'wave15',      text: '🚀 Wave 15 Cleared!',          check: (r) => r.wave >= 15            },
  { id: 'score50k',    text: '💰 50,000 Points!',            check: (r) => r.score >= 50000         },
  { id: 'survive180',  text: '⏱ Survived 3 Minutes!',       check: (r) => r.survival >= 180        },
];
...
const RATING_TIERS = [
  ...
  { min: 500,     label: 'D',   color: '#88aacc' },
  { min: 2000,    label: 'C',   color: '#3fb950' },
  { min: 8000,    label: 'B',   color: '#f7c948' },
  { min: 20000,   label: 'A',   color: '#ff8c00' },
  { min: 50000,   label: 'S',   color: '#ff4fd1' },
  { min: 150000,  label: 'S+',  color: '#bc8cff' },
];
