/**
 * meta-system.js — local meta-layer for Block Topia Quest Maze.
 *
 * Provides (all localStorage — no backend, no XP, no leaderboard changes):
 *  - Personal bests: best score, highest wave (zone), longest survival time
 ...
 * Storage key: maze_meta_v1  (unique per-game, never shared)
 */

const STORAGE_KEY = 'maze_meta_v1';
...
export const MILESTONE_DEFS = [
  { id: 'zone2',       text: '🗺️ Zone 2 Reached!',           check: (r) => r.wave >= 2             },
  ...
  { id: 'zone5',       text: '🚀 Zone 5 Reached!',           check: (r) => r.wave >= 5             },
  { id: 'score500',    text: '💰 500 Points!',                check: (r) => r.score >= 500           },
...
const RATING_TIERS = [
  ...
  { min: 50,    label: 'D',   color: '#88aacc' },
  { min: 200,   label: 'C',   color: '#3fb950' },
  { min: 500,   label: 'B',   color: '#f7c948' },
  { min: 1000,  label: 'A',   color: '#ff8c00' },
  { min: 2500,  label: 'S',   color: '#ff4fd1' },
  { min: 6000,  label: 'S+',  color: '#bc8cff' },
];
