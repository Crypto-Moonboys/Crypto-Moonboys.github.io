const SOUND_LIBRARY = {
  'invaders-shoot': {
    kind: 'sample-layer',
    samples: [
      { src: '/games/invaders-3008/attack%20fire.mp3', volume: 0.175 },
      { src: '/games/invaders-3008/attack%20fire%20two.mp3', volume: 0.175 },
    ],
  },
  'invaders-hit':       { kind: 'tone',  type: 'triangle', freqStart: 180, freqEnd: 99,  duration: 0.07, volume: 0.01 },
  'invaders-explosion': { kind: 'tone',  type: 'sawtooth', freqStart: 90,  freqEnd: 60,  duration: 0.18, volume: 0.0125 },
  'invaders-powerup':   { kind: 'tone',  type: 'triangle', freqStart: 660, freqEnd: 1320, duration: 0.14, volume: 0.01125 },
  'invaders-player-damage': { kind: 'chord', tones: [
    { type: 'sawtooth', freqStart: 220, freqEnd: 110, duration: 0.18, volume: 0.0125, delay: 0.00 },
    { type: 'square',   freqStart: 180, freqEnd: 90,  duration: 0.14, volume: 0.01, delay: 0.03 },
  ]},
  'invaders-boss-warning': { kind: 'chord', tones: [
    { type: 'sawtooth', freqStart: 160, freqEnd: 80,  duration: 0.22, volume: 0.015, delay: 0.00 },
    { type: 'square',   freqStart: 240, freqEnd: 120, duration: 0.18, volume: 0.01, delay: 0.06 },
  ]},
  'invaders-game-over': { kind: 'chord', tones: [
    { type: 'sawtooth', freqStart: 360, freqEnd: 160, duration: 0.28, volume: 0.0125, delay: 0.00 },
    { type: 'sawtooth', freqStart: 280, freqEnd: 120, duration: 0.26, volume: 0.01, delay: 0.08 },
    { type: 'triangle', freqStart: 220, freqEnd: 80,  duration: 0.24, volume: 0.01, delay: 0.18 },
  ]},
  'invaders-wave-clear': { kind: 'chord', tones: [
    { type: 'sine', freqStart: 523, freqEnd: 523, duration: 0.14, volume: 0.0125,  delay: 0.00 },
    { type: 'sine', freqStart: 659, freqEnd: 659, duration: 0.14, volume: 0.01125, delay: 0.12 },
    { type: 'sine', freqStart: 784, freqEnd: 784, duration: 0.18, volume: 0.0125,  delay: 0.24 },
    { type: 'sine', freqStart: 1047, freqEnd: 1047, duration: 0.22, volume: 0.01375, delay: 0.38 },
  ]},
  'invaders-upgrade': { kind: 'chord', tones: [
    { type: 'sine',     freqStart: 660,  freqEnd: 880,  duration: 0.16, volume: 0.0125,  delay: 0.00 },
    { type: 'triangle', freqStart: 880,  freqEnd: 1320, duration: 0.16, volume: 0.01,  delay: 0.04 },
    { type: 'sine',     freqStart: 1320, freqEnd: 1760, duration: 0.20, volume: 0.01125, delay: 0.08 },
  ]},
