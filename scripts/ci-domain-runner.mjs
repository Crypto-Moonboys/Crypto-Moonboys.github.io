...
const GROUPS = {
  ...
  'worker-api': [
    ...
    ['node', 'scripts/telegram-pets-season-completion.test.mjs'],
    ['node', 'scripts/telegram-pets-season-integrity-hotfix.test.mjs'],
    ...
    ['node', 'scripts/moonpet-runtime-audit-completion.test.mjs'],
    ...
    ['node', 'scripts/moonpet-front-action-download.test.mjs'],
    ['node', 'scripts/audit-moonpet-front-action-pack.js'],
