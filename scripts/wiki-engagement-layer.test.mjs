...
check(battleLayer.includes('battle-engagement-deck--nft-template') && battleLayer.includes('buildTemplateEngagementHTML(pageId, engagement)') && battleLayer.includes('About This NFT'), 'NFT template pages render page art, About This NFT, and Daily Missions in one engagement deck');
