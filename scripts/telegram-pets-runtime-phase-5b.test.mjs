...
assert.match(worker, /Pet care, progression, jobs, economy, runs, bosses, alerts and leaderboards run inside Moonpet OS\. Arena and Kaiju unlock only after you complete a Season pet and your active Moonpet has hatched; locked players see future panels and stale-state cleanup only/, 'help must direct gameplay into the Mini App without advertising locked combat as universally locked');
