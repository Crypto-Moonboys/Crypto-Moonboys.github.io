...
assert.ok(howTo.includes('/petwork'), 'How To Play must explain /petwork');
...
assert.ok(howTo.includes('/petevent'), 'How To Play must explain /petevent');
...
for (const term of ['crypto moonboy pets', 'telegram', 'pet game', 'tamagotchi', 'roguelite', 'pet leaderboard', 'pet adventure', 'pet notifications', 'moon gold', 'pet jobs', 'pet bag', 'daily chest', 'moon crate']) {
