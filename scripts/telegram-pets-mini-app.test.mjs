...
assert.match(worker, /const MOONPET_MINI_APP_URL = `\$\{SITE_URL\}\/moonpet-game\.html\?v=20260814-moonpet-workshop`/);
...
assert.match(html, /\/css\/moonpet-mini-app\.css\?v=20260814-moonpet-workshop/);
...
assert.match(client, /import\('\/js\/arcade\/core\/radio\.js\?v=20260814-moonpet-workshop'\)/);
...
assert.match(html, /\/js\/moonpet-mini-app\.js\?v=20260814-moonpet-workshop/);
...
assert.match(html, /20260814-moonpet-workshop/);
assert.match(worker, /20260814-moonpet-workshop/);
