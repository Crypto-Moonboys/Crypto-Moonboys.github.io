...
assert.match(html, /\/css\/moonpet-mini-app\.css\?v=20260925-botty-front-live-beta-v3/);
assert.match(html, /\/js\/moonpet-botty-front-asset-loader\.js\?v=20260925-botty-front-live-beta-v3/);
assert.match(html, /\/js\/moonpet-botty-front-sprite-renderer\.js\?v=20260925-botty-front-live-beta-v3/);
...
assert.match(html, /\/js\/moonpet-mini-app\.js\?v=20260925-botty-front-live-beta-v3/);
...
assert.match(html, /20260925-botty-front-live-beta-v3/);
