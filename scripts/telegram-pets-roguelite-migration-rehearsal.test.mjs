...
db.exec(`CREATE TABLE telegram_users (telegram_id TEXT PRIMARY KEY);
  CREATE TABLE telegram_pet_events (id TEXT PRIMARY KEY, telegram_id TEXT NOT NULL, event_key TEXT NOT NULL UNIQUE);`);
...
db.prepare("INSERT INTO telegram_pet_events VALUES ('callback-id', 'migration-player', 'callback:key:1')").run();
