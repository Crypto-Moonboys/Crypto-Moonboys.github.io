...
assert.match(html, /moonpet-botty-front-asset-loader\.js\?v=20260925-botty-front-live-beta-v3/);
assert.match(html, /moonpet-botty-front-sprite-renderer\.js\?v=20260925-botty-front-live-beta-v3/);
assert.match(html, /moonpet-mini-app\.js\?v=20260925-botty-front-live-beta-v3/);
