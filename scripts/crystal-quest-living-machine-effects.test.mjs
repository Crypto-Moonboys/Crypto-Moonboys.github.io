...
assert.match(bootstrap, /if \(isMuted\(\)\) return;[\s\S]*playSound\(soundId, generatedTones\[soundId\]\)/, 'generated Web Audio tones obey existing mute state and arcade audio helper');
