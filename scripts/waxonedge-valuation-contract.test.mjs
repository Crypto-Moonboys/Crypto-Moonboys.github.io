...
ok('WAXCASH OG headline selects legacy non-V3 direct WAX pool before Alcor V3',
  ...
  waxcashProof.headline_price.headline_price_source_policy === 'old_woe_legacy_pool_first_then_v3' &&
